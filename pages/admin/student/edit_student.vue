...
export default {
  ...
  created(){
    axios.get('http://localhost/service_ip3/admin/student/show_data_student.php', {params :{student_id: this.$route.hash.substr(1, 6)}})
      .then((resp) => {
    ...
    methods: {
      handleSubmit() {
        ...
        axios.post('http://localhost/service_ip3/admin/student/update_student.php',
        {
